...
#Vp = 14; Vs = 15; Rho = 16
VpVsRho = np.loadtxt("input_files/Ridgecrest_cvms200", usecols=[14,15,16])
print('done reading ascii Ridgecrest_cvms200')
nx=301
ny=301
nz=111
...
rootgrp = Dataset("output_files/cvms200_paraview.nc", "w", format="NETCDF4")
...
####Creating the netcdf file
from netCDF4 import Dataset
rootgrp = Dataset("output_files/rho_col_average_cvms200.nc", "w", format="NETCDF4")
...
####Creating the netcdf file
from netCDF4 import Dataset
rootgrp = Dataset("output_files/plastCo_cvms200.nc", "w", format="NETCDF4")
...
rootgrp = Dataset("output_files/RhoMuLambdaQpQs_cvms200.nc", "w", format="NETCDF4")
